...
flashcards: [
  ...
  // ============ Reforço de densidade (Bloco 19) — tópicos esparsos ============
  { id: 268, topic: 1, q: 'Diferença entre lex fori e lex causae?', a: 'LEX FORI: lei processual do foro onde tramita o processo (regra do CPC art. 13). LEX CAUSAE: lei material aplicável ao mérito, podendo ser estrangeira (LINDB). Processo segue lex fori; mérito pode seguir lex causae.', tags: ['CPC', 'lei-processual'] },
  { id: 269, topic: 1, q: 'Norma heterotópica — o que é?', a: 'Norma de natureza substancial inserida em lei processual (ou vice-versa). Ex.: CC art. 219 (interrupção da prescrição pela citação) é norma processual em código material; CPC tem regras de prescrição (heterotópicas substantivas).', tags: ['lei-processual', 'doutrina'] },
  { id: 270, topic: 2, q: 'Os 4 deveres do juiz na cooperação processual (Mitidiero)?', a: 'ESCLARECER · PREVENIR · CONSULTAR · AUXILIAR (mnemônico EPCA). Decorrem do art. 6º CPC + art. 10 (vedação à decisão-surpresa).', tags: ['principios', 'cooperacao'] },
  { id: 271, topic: 3, q: 'Teoria da asserção × in concreto das condições da ação — qual a diferença?', a: 'ASSERÇÃO (predominante no CPC/15): condições da ação verificadas à luz das ALEGAÇÕES da inicial. IN CONCRETO: verificação após dilação probatória — se faltam, sentença é DE MÉRITO (improcedência).', tags: ['teoria', 'condicoes-acao'] },
  { id: 272, topic: 4, q: 'IDPJ — quando é cabível e qual seu prazo?', a: 'Incidente de Desconsideração (CPC arts. 133-137) — cabível em todas as fases (CPC art. 134). Pode ser instaurado também em execução. Suspende o processo. Defesa em 15 dias úteis (art. 135).', tags: ['CPC', 'IDPJ'] },
  { id: 273, topic: 4, q: 'Amicus curiae — natureza jurídica e poderes?', a: 'CPC art. 138: terceiro com REPRESENTATIVIDADE adequada. Manifestação por escrito (regra) ou oral. Pode interpor recurso (limitado: embargos de declaração e em IRDR). Não é parte; intervém pela relevância da matéria.', tags: ['CPC', 'amicus-curiae'] },
  { id: 274, topic: 7, q: 'Diferença entre impedimento e suspeição (CPC arts. 144-145)?', a: 'IMPEDIMENTO: hipóteses TAXATIVAS de incompatibilidade objetiva — gera nulidade ABSOLUTA, alegável a qualquer tempo. SUSPEIÇÃO: subjetiva (parcialidade), prazo de 15 dias da ciência, gera nulidade RELATIVA.', tags: ['CPC', 'juiz'] },
  { id: 275, topic: 10, q: 'Estabilização da demanda — quando ocorre?', a: 'Após CITAÇÃO VÁLIDA (CPC art. 329): autor não pode mais alterar pedido/causa de pedir sem consentimento do réu. Antes da citação, alteração é livre. Em qualquer hipótese, antes do saneador.', tags: ['CPC', 'estabilizacao'] },
  { id: 276, topic: 12, q: 'Cumprimento de sentença que reconhece obrigação de pagar — prazo e multa?', a: 'CPC art. 523: 15 dias úteis a contar da intimação para pagar. Não pago, multa de 10% + honorários de 10% (cumulativos). Inicia execução.', tags: ['CPC', 'cumprimento'] },
  { id: 277, topic: 13, q: 'Ação monitória — pressupostos?', a: 'CPC arts. 700-702: documento ESCRITO sem eficácia executiva, prova documental do crédito, e que o credor afirme com base nele direito a obrigação de pagar, entregar coisa ou cumprir fazer/não fazer.', tags: ['CPC', 'monitoria'] },
  { id: 278, topic: 14, q: 'Jurisdição voluntária — natureza jurídica controvertida — qual a posição majoritária no CPC/15?', a: 'NATUREZA ADMINISTRATIVA (corrente clássica de Frederico Marques) ou JURISDICIONAL (Pontes de Miranda). CPC/15 a inclui no Livro de Procedimentos Especiais. Sem lide, MP intervém em alguns casos.', tags: ['CPC', 'voluntaria'] },
  { id: 279, topic: 17, q: 'Justiça gratuita — abrange quais valores?', a: 'CPC art. 98 §1º: custas, honorários, depósitos, exames, transporte, multas processuais (atual entendimento STJ). Honorários sucumbenciais ficam sob CONDIÇÃO SUSPENSIVA (5 anos — art. 98 §3º).', tags: ['CPC', 'gratuidade'] },
  { id: 280, topic: 17, q: 'Pessoa jurídica pode pleitear gratuidade da justiça?', a: 'SIM (Súmula 481/STJ) — desde que demonstre concretamente impossibilidade de arcar com custas. Ônus probatório é do requerente PJ (regra inversa à da pessoa física, que tem presunção).', tags: ['CPC', 'gratuidade', 'PJ'] },
  { id: 281, topic: 1, materia: 'civil', q: 'LINDB art. 4º — fontes em caso de omissão da lei?', a: 'ANALOGIA · COSTUMES · PRINCÍPIOS GERAIS DE DIREITO. Equidade: subsidiária, autorizada apenas quando a lei expressamente permite (art. 4º + 5º).', tags: ['fase3', 'LINDB'] },
  { id: 282, topic: 5, materia: 'civil', q: 'Diferença entre prescrição e decadência?', a: 'PRESCRIÇÃO: extingue PRETENSÃO (direito de ação) — admite suspensão/interrupção. DECADÊNCIA: extingue o próprio DIREITO POTESTATIVO — em regra não admite suspensão/interrupção. Mnemônico: prescrição se interrompe (ou é alegável), decadência fulmina.', tags: ['fase3', 'prescricao'] },
  { id: 283, topic: 10, materia: 'civil', q: 'Enriquecimento sem causa — o que é e qual o prazo prescricional?', a: 'CC arts. 884-886: vantagem econômica obtida em detrimento de outrem sem justa causa, com restituição obrigatória. PRESCRIÇÃO: 3 anos (CC art. 206 §3º IV).', tags: ['fase3', 'enriquecimento'] },
...
questions: [
  ...
  // === Reforço de densidade (Bloco 19) ===
  {
    id: 106, topic: 1, banca: 'Simulada', nivel: 'Médio',
    statement: 'Em relação à aplicação da lei processual civil no tempo, assinale a alternativa correta:',
    alternatives: [
      'A lei processual nova é retroativa, alcançando inclusive os atos já praticados sob a lei anterior.',
      'A lei processual nova aplica-se imediatamente aos processos em curso, respeitados os atos já praticados (princípio do isolamento).',
      'O CPC adota a teoria da unidade processual: a lei vigente ao tempo da propositura rege todo o processo.',
      'A territorialidade não se aplica à lei processual, que segue a lei material do direito discutido.',
      'A retroatividade benéfica se aplica à norma processual penal e à processual civil indistintamente.'
    ],
    correct: 'B',
    explanation: 'CPC art. 14: princípio do isolamento dos atos processuais — tempus regit actum. (A) Falso (não retroage). (C) Falso (não é unidade). (D) Falso — vigora lex fori (art. 13). (E) Falso — retroatividade benéfica é instituto penal.'
  },
  {
    id: 107, topic: 2, banca: 'Simulada', nivel: 'Médio',
    statement: 'Sobre o princípio da vedação à decisão-surpresa (CPC art. 10), assinale a alternativa correta:',
    alternatives: [
      'Aplica-se apenas a matérias de mérito, ficando excluídas as questões de ordem pública.',
      'O juiz pode decidir de ofício matéria cognoscível ex officio sem prévia oitiva das partes, conforme jurisprudência consolidada do STJ.',
      'O juiz não pode decidir, em qualquer grau de jurisdição, com base em fundamento sobre o qual as partes não tenham tido oportunidade de se manifestar, mesmo se for matéria conhecível de ofício.',
      'A vedação só se aplica a fundamentos jurídicos novos, jamais a questões fáticas.',
      'Trata-se de norma sem sanção processual, mero conselho hermenêutico.'
    ],
    correct: 'C',
    explanation: 'CPC art. 10 + STJ (REsp 1.676.027/PR): a vedação à decisão-surpresa abrange até matérias cognoscíveis de ofício. Sua violação acarreta nulidade.'
  },
  {
    id: 108, topic: 3, banca: 'Simulada', nivel: 'Médio',
    statement: 'No CPC/15, as condições da ação compreendem:',
    alternatives: [
      'Legitimidade, interesse e possibilidade jurídica do pedido.',
      'Apenas legitimidade e interesse — a possibilidade jurídica do pedido foi absorvida pela análise do mérito.',
      'Apenas o interesse processual.',
      'Pressupostos processuais e condições da ação são sinônimos.',
      'Capacidade processual, legitimidade, interesse e possibilidade jurídica.'
    ],
    correct: 'B',
    explanation: 'CPC/15 não menciona possibilidade jurídica como condição autônoma — passou a integrar o mérito (Liebman antecipou). Restam: legitimidade e interesse (CPC art. 17 + 485 VI).'
  },
  {
    id: 109, topic: 10, banca: 'Simulada', nivel: 'Médio',
    statement: 'Sobre a extinção do processo sem resolução de mérito (CPC art. 485), é INCORRETO afirmar:',
    alternatives: [
      'A extinção por abandono do autor depende de requerimento do réu (Súmula 240/STJ).',
      'O juiz pode extinguir, de ofício, em caso de litispendência, coisa julgada e perempção.',
      'A extinção por inércia do autor que não cumpre diligência opera independentemente de intimação pessoal.',
      'A sentença terminativa não impede a repropositura da ação, salvo perempção.',
      'O abandono bilateral leva à extinção pelo art. 485, II, mas demanda intimação pessoal das partes.'
    ],
    correct: 'C',
    explanation: 'CPC art. 485 §1º: a extinção por inércia exige intimação PESSOAL do autor para manifestar-se em 5 dias. (A) Súmula 240/STJ. (B) Art. 485 §3º. (D) Salvo art. 486 §1º. (E) Correto.'
  },
  {
    id: 110, topic: 13, banca: 'Simulada', nivel: 'Médio',
    statement: 'Sobre os procedimentos especiais de jurisdição contenciosa do CPC/15, assinale a correta:',
    alternatives: [
      'A ação de consignação em pagamento extrajudicial dispensa a citação do credor.',
      'Na ação monitória, oferecidos embargos, suspende-se a eficácia do mandado e o feito segue o procedimento comum.',
      'Inventário e partilha apenas podem tramitar em juízo, sendo proibido o procedimento extrajudicial.',
      'A ação de exigir contas tem rito sumaríssimo, com prazo de 5 dias para resposta.',
      'O usucapião extrajudicial foi extinto pela Lei 14.382/22.'
    ],
    correct: 'B',
    explanation: 'CPC art. 702: opostos embargos, suspende-se a eficácia do mandado e o procedimento converte-se em comum. (A) Lei 8.078, dispensa apenas eventualmente. (C) Falso — Lei 11.441/07 e 14.382/22 ampliam o extrajudicial. (D) Falso — rito ordinário com prazo de 15 dias. (E) Falso — Lei 14.382/22 ampliou.'
  },
  {
    id: 111, topic: 14, banca: 'Simulada', nivel: 'Médio',
    statement: 'A respeito da jurisdição voluntária no CPC/15, é correto afirmar:',
    alternatives: [
      'O juiz fica adstrito ao critério de legalidade estrita (CPC art. 723).',
      'O juiz não está obrigado a observar critério de legalidade estrita, podendo adotar a solução que reputar mais conveniente ou oportuna.',
      'Não há contraditório nem participação do MP.',
      'Não cabe recurso das decisões em jurisdição voluntária.',
      'A jurisdição voluntária é atividade jurisdicional típica, com lide e contraditório obrigatório.'
    ],
    correct: 'B',
    explanation: 'CPC art. 723 § único: o juiz não é obrigado a observar critério de legalidade estrita — busca solução conveniente ou oportuna. (A) Falso. (C) Falso, há contraditório. (D) Falso — cabe apelação. (E) Falso — natureza administrativa controvertida.'
  },
  {
    id: 112, topic: 11, materia: 'civil', banca: 'Simulada', nivel: 'Difícil',
    statement: 'Sobre a responsabilidade civil objetiva no CC, marque a correta:',
    alternatives: [
      'É consagrada apenas no Código de Defesa do Consumidor; o CC adota a culpa como regra absoluta.',
      'O parágrafo único do art. 927 do CC consagra a responsabilidade objetiva quando a atividade desenvolvida pelo autor do dano implicar, por sua natureza, risco para os direitos de outrem.',
      'A teoria do risco integral aplica-se a todas as hipóteses do art. 927, parágrafo único.',
      'A responsabilidade objetiva exige culpa grave do agente.',
      'A teoria do risco criado nunca foi incorporada ao direito brasileiro.'
    ],
    correct: 'B',
    explanation: 'CC art. 927 § único: responsabilidade objetiva por atividade de risco. Adotou-se a teoria do risco criado. Risco integral é exceção (acidente nuclear, dano ambiental).'
  },
  {
    id: 113, topic: 12, materia: 'civil', banca: 'Simulada', nivel: 'Médio',
    statement: 'Sobre o direito de empresa no CC, é INCORRETO afirmar:',
    alternatives: [
      'A sociedade limitada unipessoal foi introduzida pela Lei 13.874/19.',
      'A EIRELI foi extinta pela Lei 14.195/21.',
      'O empresário individual não tem personalidade jurídica distinta da pessoa natural.',
      'A desconsideração da personalidade jurídica (CC art. 50) exige, em regra, requerimento da parte ou do MP.',
      'A teoria menor da desconsideração é a regra geral no CC, dispensando-se a prova de abuso.'
    ],
    correct: 'E',
    explanation: 'CC art. 50: regra geral é a TEORIA MAIOR — exige abuso da personalidade (desvio de finalidade ou confusão patrimonial). A teoria menor (CDC art. 28 §5º) é exceção. (A), (B), (C), (D) corretas.'
  },
  {
    id: 114, topic: 15, materia: 'civil', banca: 'Simulada', nivel: 'Médio',
    statement: 'Sobre o regime de bens no casamento (CC arts. 1.639-1.688), assinale a correta:',
    alternatives: [
      'O regime supletivo legal é o da comunhão universal de bens.',
      'Não é possível a alteração do regime de bens após a celebração do casamento.',
      'O regime supletivo legal é o da comunhão parcial e a alteração é admitida em juízo, mediante motivação e ressalva de direitos de terceiros (CC art. 1.639 §2º).',
      'O regime de separação obrigatória aplica-se ao casamento de qualquer pessoa maior de 60 anos, sem exceção.',
      'O pacto antenupcial é desnecessário para qualquer regime distinto da comunhão parcial.'
    ],
    correct: 'C',
    explanation: 'CC art. 1.640 (comunhão parcial supletiva) + art. 1.639 §2º (alteração possível por decisão judicial motivada). (D) Falso — STF revogou idade rígida; hoje regra é 70 anos (Lei 12.344/10) e há entendimentos pela inconstitucionalidade.'
  },
  {
    id: 115, topic: 11, banca: 'Simulada', nivel: 'Médio',
    statement: 'No procedimento comum do CPC/15, sobre o prazo de defesa do réu, é correto afirmar:',
    alternatives: [
      'A contagem do prazo de 15 dias úteis para contestar inicia-se da própria juntada do AR, sem audiência prévia de conciliação.',
      'O termo inicial do prazo de contestação é a data da audiência de conciliação, salvo cancelamento ou hipótese de não realização.',
      'O prazo é de 30 dias úteis para contestar quando o autor for a Fazenda Pública.',
      'O réu deve apresentar reconvenção em peça autônoma, sob pena de preclusão.',
      'A contestação não comporta preliminares — tudo deve ser alegado em peça separada.'
    ],
    correct: 'B',
...
sumulas: [
  ...
  // === Reforço PC (do HANDOFF — pendentes) ===
  { tribunal: 'STJ', tipo: 'Súmula', num: 14, topic: 6, text: 'Arrolados os bens com a citação do cônjuge meeiro, não se exige a sua intimação para os atos processuais subsequentes.' },
  { tribunal: 'STJ', tipo: 'Súmula', num: 41, topic: 6, text: 'O Superior Tribunal de Justiça não tem competência para processar e julgar, originariamente, mandado de segurança contra ato de outros tribunais ou dos respectivos órgãos.' },
  { tribunal: 'STJ', tipo: 'Súmula', num: 121, topic: 17, text: 'Na execução fiscal, o devedor deverá ser intimado, pessoalmente, do dia e hora da realização do leilão.' },
  { tribunal: 'STJ', tipo: 'Súmula', num: 168, topic: 16, text: 'Não cabem embargos de divergência, quando a jurisprudência do tribunal se firmou no mesmo sentido do acórdão embargado.' },
  { tribunal: 'STJ', tipo: 'Súmula', num: 380, topic: 14, text: 'A simples propositura da ação de revisão de contrato não inibe a caracterização da mora do autor.' },
  { tribunal: 'STJ', tipo: 'Súmula', num: 423, topic: 8, text: 'A Contribuição para Financiamento da Seguridade Social - Cofins incide sobre as receitas provenientes das operações de locação de bens móveis.' },
  { tribunal: 'STJ', tipo: 'Súmula', num: 545, topic: 11, text: 'Quando a confissão for utilizada para a formação do convencimento do julgador, o réu fará jus à atenuante prevista no art. 65, III, d, do Código Penal.', materia: 'penal' },
  { tribunal: 'STJ', tipo: 'Súmula', num: 643, topic: 19, text: 'A execução da pena restritiva de direitos depende do trânsito em julgado da condenação.', materia: 'penal' },

  // === Súmulas para matérias novas (Penal, Const., Trib., Coletivo) ===
  { tribunal: 'STF', tipo: 'SV', num: 8, topic: 5, materia: 'trib', text: 'São inconstitucionais o parágrafo único do artigo 5º do Decreto-Lei nº 1.569/1977 e os artigos 45 e 46 da Lei nº 8.212/1991, que tratam de prescrição e decadência de crédito tributário.' },
  { tribunal: 'STF', tipo: 'SV', num: 24, topic: 10, materia: 'trib', text: 'Não se tipifica crime material contra a ordem tributária, previsto no art. 1º, incisos I a IV, da Lei nº 8.137/90, antes do lançamento definitivo do tributo.' },
  { tribunal: 'STF', tipo: 'SV', num: 26, topic: 11, materia: 'pp', text: 'Para efeito de progressão de regime no cumprimento de pena por crime hediondo, ou equiparado, o juízo da execução observará a inconstitucionalidade do art. 2º da Lei nº 8.072, de 25 de julho de 1990, sem prejuízo de avaliar se o condenado preenche, ou não, os requisitos objetivos e subjetivos do benefício, podendo determinar, para tal fim, de modo fundamentado, a realização de exame criminológico.' },
